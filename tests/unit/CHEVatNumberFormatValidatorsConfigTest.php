...
namespace rocketfellows\CHEVatNumberFormatValidatorsConfig\tests\unit;

use arslanimamutdinov\ISOStandard3166\ISO3166;
use PHPUnit\Framework\TestCase;
use rocketfellows\CHEVatFormatValidator\CHEVatFormatValidator;
use rocketfellows\CHEVatNumberFormatValidatorsConfig\CHEVatNumberFormatValidatorsConfig;
...
class CHEVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = CHEVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = CHEVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::CH(), $config->getCountry());
    }
